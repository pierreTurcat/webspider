...
var i = 0;
while (i < verifyDouble.length){
  if (verifyDouble[i] != url){
    console.log("try");
  }
  i++;
}
  queue.push(url);
  //verifyDouble.add[url];
  

// I found an example for this here ==> http://stackoverflow.com/questions/2496710/writing-files-in-nodejs
